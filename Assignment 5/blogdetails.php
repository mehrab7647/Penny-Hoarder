    ...
    <div class="wrapper-container">
        ...
        <main class="main-content">
            ...
            <div class="content-box">
                <!-- Blog Image and Voting Section -->
                <div class="flex-container">
                    <div class="image-wrapper">
                        <?php if (!empty($post["image_path"])): ?>
                            <img src="<?= htmlspecialchars($post["image_path"]) ?>" alt="Blog Image">
                        <?php else: ?>
                            <img src="https://via.placeholder.com/300x200?text=No+Image" alt="No Blog Image">
                        <?php endif; ?>
                    </div>
                    <!-- Upvote and Downvote Section -->
                    <div class="vote-container">
                        <div class="vote-icon">&#8679;</div>
                        <div class="vote-count-new">231</div>
                    ...
                    <?php while ($comment = $comments->fetch_assoc()): ?>
                        ...
                        <div class="comment-item">
                            <div class="comment-avatar-new">
                                <img src="<?= htmlspecialchars($comment["avatar"]) ?>" alt="User Avatar">
                            </div>
                            <div class="comment-details">
                                ...
                                <div class="comment-actions">
                                    <div class="vote-icon">&#8679;</div>
                                    <div class="vote-count-new">54</div>
                                    <div class="downvote-icon">&#8681;</div>
                                </div>
                            </div>
                        </div>
